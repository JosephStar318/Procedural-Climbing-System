...
public class ClimbingController : MonoBehaviour
{
    ...
    private void ClimbMovement()
    {
        ...
        {
            if(animator.GetCurrentAnimatorStateInfo(0).shortNameHash != HashManager.animatorHashDict[AnimatorVariables.BracedHangingBlendState])
            {
                return;
            }
